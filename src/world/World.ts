...
export class World extends Phaser.GameObjects.Container {
    ...
    constructor(public scene: MainScene) {
        ...
        this.windForce = {
            sway: new Sway(50, -0.25, 1.5, 0.005),
        ...
        this.rainSprite = this.scene.add.tileSprite(0, 0, this.scene.cameras.main.width, this.scene.cameras.main.height, 'rain_particles');
    ...
    update() {
        ...
        windDirection.scale(this.windForce.sway.getLength() * 2);
        const yScale = 0.6 + NumberUtils.clamp(0, 0.4, windDirection.x / 300);

        this.rainSprite.tilePositionX += 1;
        this.rainSprite.tilePositionY += 1;
